...
#define FFMPEG_CONFIGURATION "--arch=ppc --enable-libmp3lame --enable-libvorbis --enable-libtheora --enable-libopus --disable-debug --enable-libwebp --enable-libfreetype --disable-doc --disable-network --disable-iconv --disable-runtime-cpudetect --cc=ppc-morphos-gcc --extra-cflags=-noixemul --target-os=none --enable-cross-compile --enable-gpl --enable-version3 --disable-ffprobe --disable-pthreads --enable-zlib --enable-bzlib --enable-lzma --enable-openssl --enable-nonfree --enable-libmodplug --disable-sdl2"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2021
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "gcc 10.2.0 (GCC/MorphOS)"
...
#define CONFIG_SAFE_BITSTREAM_READER 0 // 160421 MPLAYER FAB comment
