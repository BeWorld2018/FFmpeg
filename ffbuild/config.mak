...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--arch=ppc --enable-libmp3lame --enable-libvorbis --enable-libtheora --enable-libopus --disable-debug --enable-libwebp --enable-libfreetype --disable-doc --disable-iconv --disable-runtime-cpudetect --cc=ppc-morphos-gcc --extra-cflags=-noixemul --target-os=none --enable-cross-compile --enable-gpl --enable-version3 --disable-ffprobe --disable-pthreads --enable-zlib --enable-bzlib --enable-lzma --enable-openssl --enable-nonfree --enable-libmodplug --disable-sdl2
prefix=/usr/local
...
CC_IDENT=gcc 10.2.0 (GCC/MorphOS)
ARCH=ppc
INTRINSICS=none
EXTERN_PREFIX=
...
DLLTOOL=
WINDRES=windres
DEPWINDRES=ppc-morphos-gcc
DOXYGEN=doxygen
LDFLAGS= -N -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=:libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDSOFLAGS=
...
CFLAGS-ffplay=-noixemul -I/usr/local/include/SDL2
...
EXTRALIBS-avutil=
EXTRALIBS-ffplay= -L/usr/local/lib -noixemul -lSDL2 -lfreetype -lmp3lame -lopusfile -lopus -ltheoraenc -ltheoradec -lvorbisfile -lvorbisenc -lvorbis -logg -lmodplug -lwebp -lbz2 -lz_shared -lpng_shared -lssl -lcrypto -lnghttp2 -lm 
EXTRALIBS-ffprobe=
EXTRALIBS-ffmpeg= -L/usr/local/lib -noixemul -lfreetype -lmp3lame -lopusfile -lopus -ltheoraenc -ltheoradec -lvorbisfile -lvorbisenc -lvorbis -logg -lmodplug -lwebp -lbz2 -lz_shared -lpng_shared -lssl -lcrypto -lnghttp2 -lm 
EXTRALIBS-cpu_init=
EXTRALIBS-cws2fws=
!ARCH_AARCH64=yes
!ARCH_ALPHA=yes
